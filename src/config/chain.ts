...
export interface ContractAddress {
  readonly USDC_ADDRESS:Address,
  readonly POOL_ADDRESS:Address,
  readonly POOL_VIEW_ADDRESS:Address,
  readonly HYPER_VAULT_ADDRESS:Address,
  readonly FEE_COLLECTOR_ADDRESS:Address,
  readonly POSITION_MANAGER_ADDRESS:Address,
  readonly ORDER_MANAGER_ADDRESS:Address,
  readonly TRUSTED_FORWARDER_ADDRESS:Address,
  readonly FRONT_FACET_ADDRESS:Address, // router address
  readonly DELEGATE_FACET_ADDRESS:Address, // Seamless router address
  readonly FAUCET_ADDRESS:Address,
  readonly UI_POOL_DATA_PROVIDER_ADDRESS:Address,
  readonly UI_POSITION_DATA_PROVIDER_ADDRESS:Address,
