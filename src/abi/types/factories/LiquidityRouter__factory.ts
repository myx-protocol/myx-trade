...
export class LiquidityRouter__factory {
  static readonly abi = _abi;
  static createInterface(): LiquidityRouterInterface {
    return new Interface(_abi) as LiquidityRouterInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): LiquidityRouter {
    return new Contract(address, _abi, runner) as unknown as LiquidityRouter;
  }
}
