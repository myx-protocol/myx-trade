...
export const ResetSetPasswordDialog = () => {
  const { resetSeamlessPasswordDialogOpen, setResetSeamlessPasswordDialogOpen } = useGlobalStore()
  ...
  return (
    <DialogBase
      ...
      open={resetSeamlessPasswordDialogOpen}
      onClose={() => {
        setResetSeamlessPasswordDialogOpen(false)
      }}
      sx={{
        '& .MuiDialog-paper': {
          paddingLeft: 0,
