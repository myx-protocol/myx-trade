...
const TradePage: React.FC = () => {
  ...
  const handleApproval = async () => {
    ...
    setApproving(true);
    try {
      const rs = await myxClient?.approveAuthorization({
  ...
  return (
    <div style={{ maxWidth: 1200, margin: "0 auto", padding: "24px" }}>
                        ...
                        <div className="text-xs">
                          ...
                          <span
                            className={`ml-1 px-2 py-1 rounded text-white text-xs ${
                              pool.state === 2 ? "bg-green-500" : "bg-red-500"
                            }`}
                          >
            ...
            >
              <Row gutter={[16, 16]}>
                ...
                <Col span={12}>
                  ...
                  >
                    <Form.Item
                      label={`保证金数量 / Collateral Amount (${
                        selectedPool?.quoteSymbol || "USDT"
                      })`}
                    ...
                    <Form.Item
                      label={`交易数量 / Trade Size (${
                        selectedPool?.baseSymbol || "Token"
                      })`}
                      name="size"
                    >
                      <InputNumber style={{ width: "100%" }} min={0} />
      ...
      <Form.Item
        label={`订单ID(逗号隔开) / Order IDs (comma separated)`}
