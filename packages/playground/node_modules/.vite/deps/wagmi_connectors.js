...
// ../../node_modules/.pnpm/@wagmi+connectors@5.9.9_@types+react@19.1.11_@wagmi+core@2.20.3_@tanstack+query-core@5.85.6_@_ytappr3dpc5lozonyelutjno5u/node_modules/@wagmi/connectors/dist/esm/baseAccount.js
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-KHIJ6DKG.js");
...
// ../../node_modules/.pnpm/@wagmi+connectors@5.9.9_@types+react@19.1.11_@wagmi+core@2.20.3_@tanstack+query-core@5.85.6_@_ytappr3dpc5lozonyelutjno5u/node_modules/@wagmi/connectors/dist/esm/coinbaseWallet.js
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-AIGSXA5L.js");
    ...
    async getProvider() {
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-BXCGOBTO.js");
...
// ../../node_modules/.pnpm/@gemini-wallet+core@0.2.0_viem@2.36.0_bufferutil@4.0.9_typescript@5.8.3_utf-8-validate@5.0.10_zod@3.22.4_/node_modules/@gemini-wallet/core/dist/index.js
...
// ../../node_modules/.pnpm/@wagmi+connectors@5.9.9_@types+react@19.1.11_@wagmi+core@2.20.3_@tanstack+query-core@5.85.6_@_ytappr3dpc5lozonyelutjno5u/node_modules/@wagmi/connectors/dist/esm/gemini.js
gemini.type = "gemini";
...
// ../../node_modules/.pnpm/@wagmi+connectors@5.9.9_@types+react@19.1.11_@wagmi+core@2.20.3_@tanstack+query-core@5.85.6_@_ytappr3dpc5lozonyelutjno5u/node_modules/@wagmi/connectors/dist/esm/metaMask.js
    ...
    async getProvider() {
      async function initProvider() {
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-IL4JNFUJ.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
...
// ../../node_modules/.pnpm/@wagmi+connectors@5.9.9_@types+react@19.1.11_@wagmi+core@2.20.3_@tanstack+query-core@5.85.6_@_ytappr3dpc5lozonyelutjno5u/node_modules/@wagmi/connectors/dist/esm/safe.js
safe.type = "safe";
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-4ORCEJH4.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-5AOTY323.js");
...
// ../../node_modules/.pnpm/@wagmi+connectors@5.9.9_@types+react@19.1.11_@wagmi+core@2.20.3_@tanstack+query-core@5.85.6_@_ytappr3dpc5lozonyelutjno5u/node_modules/@wagmi/connectors/dist/esm/version.js
var version2 = "5.9.9";

// ../../node_modules/.pnpm/@wagmi+connectors@5.9.9_@types+react@19.1.11_@wagmi+core@2.20.3_@tanstack+query-core@5.85.6_@_ytappr3dpc5lozonyelutjno5u/node_modules/@wagmi/connectors/dist/esm/walletConnect.js
    ...
    async getProvider() {
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-NWH2WHIK.js");
