...
import {
  ...
  hexToNumber,
  numberToHex
} from "./chunk-EXW7A524.js";
import "./chunk-BFKV2BUH.js";
import "./chunk-NXHYJ2OZ.js";
import "./chunk-XQJRPTTO.js";
import "./chunk-QEK2ZTOW.js";

// ../../node_modules/.pnpm/@wagmi+connectors@5.9.9_@types+react@19.1.11_@wagmi+core@2.20.3_@tanstack+query-core@5._b7231c0b445d4a743b63861abb0c64ed/node_modules/@wagmi/connectors/dist/esm/baseAccount.js
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-BLF2QVQL.js");
...
// ../../node_modules/.pnpm/@wagmi+connectors@5.9.9_@types+react@19.1.11_@wagmi+core@2.20.3_@tanstack+query-core@5._b7231c0b445d4a743b63861abb0c64ed/node_modules/@wagmi/connectors/dist/esm/coinbaseWallet.js
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-QQUQ5IDD.js");
    ...
    async getProvider() {
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-ZAXR6XC3.js");
...
// ../../node_modules/.pnpm/@wagmi+connectors@5.9.9_@types+react@19.1.11_@wagmi+core@2.20.3_@tanstack+query-core@5._b7231c0b445d4a743b63861abb0c64ed/node_modules/@wagmi/connectors/dist/esm/gemini.js
gemini.type = "gemini";
...
// ../../node_modules/.pnpm/@wagmi+connectors@5.9.9_@types+react@19.1.11_@wagmi+core@2.20.3_@tanstack+query-core@5._b7231c0b445d4a743b63861abb0c64ed/node_modules/@wagmi/connectors/dist/esm/metaMask.js
...
// ../../node_modules/.pnpm/@wagmi+connectors@5.9.9_@types+react@19.1.11_@wagmi+core@2.20.3_@tanstack+query-core@5._b7231c0b445d4a743b63861abb0c64ed/node_modules/@wagmi/connectors/dist/esm/safe.js
safe.type = "safe";
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-W7LYRVX6.js");
...
// ../../node_modules/.pnpm/@wagmi+connectors@5.9.9_@types+react@19.1.11_@wagmi+core@2.20.3_@tanstack+query-core@5._b7231c0b445d4a743b63861abb0c64ed/node_modules/@wagmi/connectors/dist/esm/version.js
var version2 = "5.9.9";

// ../../node_modules/.pnpm/@wagmi+connectors@5.9.9_@types+react@19.1.11_@wagmi+core@2.20.3_@tanstack+query-core@5._b7231c0b445d4a743b63861abb0c64ed/node_modules/@wagmi/connectors/dist/esm/walletConnect.js
    ...
    async getProvider() {
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-BTPA6POI.js");
