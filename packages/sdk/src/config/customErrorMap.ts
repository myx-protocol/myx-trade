export const customErrorMapping: Record<string, string> = {
  ...
  "0x62b925f6": "ForwardedRecipientMustBeMasterAccount(address,address)",
  ...
  "0x70c770c6": "OnlyMarketDecreaseOrder(OrderId)",
  "0x4578ddb8": "OnlyRelayer()",
  "0x25e25e9e": "OrderNotExpired(OrderId)",
  ...
  "0xe356c1d3": "TargetNotAllowed(address)",
  "0x90b8ec18": "TransferFailed()",
  "0xbe1af266": "InternalOnly()",
  "0x856bc1d7": "ExceedMaxOrderCount()",
  ...
  "0x1b5305a8": "InsufficientRedeemable()",
  "0x14be833f": "InsufficientReturnAmount(uint256,uint256)",
  "0x419ecd12": "MatchNotSupported()",
  "0x5e6797f9": "NotEligibleForLiquidation()",
  "0x9ed303a0": "PoolFundingFeeNotPositive()",
  ...
  "0x3e4f8296": "InvalidFeeRateLength()",
  ...
  "0xaa2c80d8": "CollectFailed()",
  "0xbec00580": "DeadlineInPast()",
  "0x59392ffb": "ExecutionExpired(TxId)",
  "0x09bb89be": "ExecutionNotExpired(TxId)",
  "0xc6a092ef": "ExecutionsNotExist(TxId)",
  "0x5eb3095c": "InsufficientGasEscrow()",
  "0xdfe93090": "InvalidDataLength()",
  "0x73a65a48": "InvalidGasEscrow()",
  "0x41abc801": "InvalidRequest()",
  "0x1b463d8f": "MaxPendingExceeded()",
  "0x8bfbae9a": "NotExecutionOwner(TxId)",
  "0xd2a28b55": "PoolNotExists(PoolId)",
  "0xf0a6cb04": "RefundExceedsEscrow(uint256,uint256)",
  "0x919c2db4": "RefundFailed(TxId)",
  "0x57d5ae0c": "SelectorNotRegistered(bytes4)",
  "0xf1532544": "TxIdAlreadyExists(TxId)",
  ...
  "0xd96ce906": "PriceIdMismatch()",
  "0x148cd0dd": "VerifyPriceFailed()",
  "0x296e3882": "BoostFeeClaimFailed()",
  "0xdacec8b1": "PoolBoostReserveInsufficient()",
  ...
  "0x7decb035": "PoolDebtNotCleared()",
  "0x1acb203e": "PositionNotEmpty()",
  "0xdb752ffd": "UnauthorizedUnboost()",
  ...
  "0x78ee2fc5": "EthCallCountMismatch()",
  ...
  "0x6882d7a1": "ResponseCountMismatch()",
  "0x12f1361a": "StaleEthCall()",
  ...
  "0xe12dff41": "InvalidProfitLock()",
  "0x3f902c55": "NoActiveDispute()",
  "0xb923cca7": "PositionHasLockedAmount()",
  "0x6dfcc650": "SafeCastOverflowedUintDowncast(uint8,uint256)",
  "0xd24b47fb": "UserProfitFrozen()",
  "0x176ae915": "InvalidBaseSlippage()",
  "0xd1d452de": "InvalidBaseTokenCollateralRatio()",
  "0x7469d2b7": "InvalidEpochDuration(uint32)",
  "0xeae25452": "InvalidExchangeIncentiveRate()",
  "0x894b012b": "InvalidGenesisRebateRatio()",
  "0x7fd13972": "InvalidLeverage()",
  "0x69fc7240": "InvalidMaintainMarginRate()",
  "0x8f11d7d2": "InvalidMaxCloseSlippage()",
  "0x75e50d4b": "InvalidMaxPriceDeviation()",
  "0xc2c20924": "InvalidMinTradeUsd()",
  "0x9a50eaa5": "InvalidPriceRangePct()",
  "0xa61eabbd": "InvalidWindowCapUsd()",
  "0xa147bb92": "InvalidWindowSize()",
  ...
  "0x37bc9350": "InvalidPriceTimestamp()",
  "0xe47b1dbe": "InvalidPriceUpdater()",
  "0x18b88897": "InvalidUpdateFee()",
  "0x37d0adb4": "MismatchedPriceWithRewindPair()",
  "0xf76740e3": "PriceDeviationBelowMinimum()",
  "0x49386283": "PriceDeviationThresholdReached()",
  "0x5d3751fc": "PriceSourceNotHealthy()",
  "0x43fc1c57": "PriceUpdaterAlreadyAdded(address)",
  "0x8e2b6896": "PriceUpdaterNotFound(address)",
  "0x7f84faec": "PublishTimeMismatch()",
